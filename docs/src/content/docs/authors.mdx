...
Inspired by SolidaJS, I — Alexandru — created a state-management library called solidart, also featuring providers and a `Solid` widget, the equivalent of this library's `ProviderScope`.
