...
This AutoRoute example shows how to share a provider between multiple pages without scoping the entire app.

This can be considered as a more advanced example and can be used when you want to share a provider between multiple pages without scoping the entire app.
