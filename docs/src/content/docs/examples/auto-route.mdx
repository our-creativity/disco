...
<LinkCard title="Source code" description="Tap here to check the full source code of this example" href="https://github.com/our-creativity/disco/tree/main/examples/auto_route" />
...
This the `auto_route` version used in this example:
