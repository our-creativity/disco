...
|---------------------------|--------------------------------|-------------------------------------|
| <small>Typical Scoped DI</small>         | <small>`context.read<Model>()`</small>        | <small>Not possible</small>                        |
| <small>Disco (Conceptual Syntax)</small> | <small>`context.read(modelProvider)`</small>  | <small>`context.read(secondModelProvider)`</small> |
| <small>Disco (Actual Syntax)</small>     | <small>`modelProvider.of(context)`</small>    | <small>`secondModelProvider.of(context)`</small>   |
